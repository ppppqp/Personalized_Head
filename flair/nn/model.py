...
class Model(torch.nn.Module):
    ...
    @classmethod
    def load(cls, model: Union[str, Path],nhead=8,ff_dim=256,fine_tune=False):
        """
        ...
        with warnings.catch_warnings():
            ...
            # print(f' state_dict : {state["state_dict"]}')
        model = cls._init_model_with_state_dict(state,ff_dim=ff_dim,nhead=nhead,fine_tune=fine_tune
        )
